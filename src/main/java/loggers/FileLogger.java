...
public class FileLogger extends Logger {
	...
	/* CONSTRUCTORS */
	/**
	 * Creates a FileLogger with an associated request level level.
	 * 
	 ...
	 * 
	 * @param filePath The path of the file in which the FileLogger to create will
	 *                 log
	 * @param level    THe log request level associated with the FileLogger to
	 *                 create
	 */
	 ...
	 * 
	 * @param filePath The value to set this FileLogger's associated file path.
	 */
	...
	/**
	 * Appends request's message in this FileLogger's associated file.
	 */
	@Override
